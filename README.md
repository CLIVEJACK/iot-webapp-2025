...
- AWS 라이트세일 - https://blog.naver.com/gi_balja/223390175873
    - 기존 AWS보다 저렴하게 사용할 수 있는 서비스

#### AWS 라이트세일에 웹서버 올리기
1. 인스턴스 생성
    1. Microsoft Windows > Window Server 2019 > 
    2. 네트워크 듀얼스택
    3. 크기, 월별 $9.5 선택 `90일 무료`
    4. 인스턴스 이름
    5. 인스턴스 생성
2. 인스턴스 관리 > RDP를 사용하여 연결
    1. 초기화 대기(네트워크 나올떄까지, 1분가량)
...
4. MySQL 설치
    1. Custom 선택
    2. MySQL Server 8.0.34 - x64 선택, 설치 후 Next
    3. 일반적으로 Next
